...
import com.example.timepicker.adapter.NumericWheelAdapter;
import com.example.timepicker.config.PickerConfig;
import com.example.timepicker.config.PickerContants;
import com.example.timepicker.config.Utils;
import com.example.timepicker.data.TimeRepository;
...
public class TimeWheel {
    ...
    public TimeWheel(Context context, View view, PickerConfig pickerConfig) {
