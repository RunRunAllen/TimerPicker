...
import com.example.timepicker.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void initData(Context context) {
        ...
        mPaintLineCenter.setColor(DefaultConfig.LINE_COLOR);
        ...
        mPaintLineRight.setColor(DefaultConfig.LINE_RIGHT_COLOR);
        ...
        mPaintRectCenter.setColor(DefaultConfig.ITEM_BACK_COLOR);
    ...
    public void setConfig(PickerConfig config) {
        mPaintLineCenter.setColor(config.mItemLineColor);

        mPaintRectCenter.setColor(config.mItemBackColor);
        mPaintRectCenter.setAlpha((int) (0.1 * 255));
